...
public class RestWorkload extends CoreWorkload {
  ...
  private static final String READ_ZIPFIAN_CONSTANT_DEAFULT = "0.9";
  ...
  private static final String INSERT_ZIPFIAN_CONSTANT_DEAFULT = "0.9";
  private static final String INSERT_SIZE_ZIPFIAN_CONSTANT = "insertsizezipfconstant";
  private static final String INSERT_SIZE_ZIPFIAN_CONSTANT_DEAFULT = "0.9";
  ...
  private static final String DELETE_ZIPFIAN_CONSTANT_DEAFULT = "0.9";
  ...
  private static final String UPDATE_ZIPFIAN_CONSTANT_DEAFULT = "0.9";
